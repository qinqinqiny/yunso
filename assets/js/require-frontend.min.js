...
require.config({
    ...
    paths: {
		...
		'layui':'https://www.layuicdn.com/layui-v2.6.8/layui',
        //  		'layui':'https://www.layuicdn.com/layui-v2.6.8/layui.js',
		// layui 2.6.8 ../layui/layui
        // 以下的包从bower的libs目录加载
	...
	'layui': {
           ...
           init: function () {
               return this.layui.config({dir: 'https://www.layuicdn.com/layui-v2.6.8/'});
	}},
        'addons': ['frontend'],
        'bootstrap': ['jquery'],
        'bootstrap-table': {
...
//手工编辑 'layui','layer
require(['jquery', 'bootstrap','layui','layer'], function ($, undefined) {
    //初始配置
